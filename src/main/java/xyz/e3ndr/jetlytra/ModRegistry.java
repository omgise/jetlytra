...
public class ModRegistry {
    ...
    // @formatter:off
    public static final Item itemLeadstoneFluxLytra = new FluxElytra("leadstone_flux_elytra",     80_000,    200, 0.1, 50);
    public static final Item itemHardenedFluxLytra  = new FluxElytra("hardened_flux_elytra",     400_000,    800, 0.3, 30);
    public static final Item itemRedstoneFluxLytra  = new FluxElytra("redstone_flux_elytra",   4_000_000,  8_000, 0.7, 15);
    public static final Item itemResonantFluxLytra  = new FluxElytra("resonant_flux_elytra",  20_000_000, 32_000, 1.0,  1);
    // @formatter:on
